...
|----------|-------------|----------|
| 🍎 **macOS** | ARM64 (M1/M2/M3) | [Boorie-1.18.0-arm64.dmg](https://github.com/Boorie-AI/boorie_cliente/releases/download/v1.18.0/Boorie-1.18.0-arm64.dmg) |
| 🪟 **Windows** | x64 | [Boorie-Setup-1.18.0.exe](https://github.com/Boorie-AI/boorie_cliente/releases/download/v1.18.0/Boorie-Setup-1.18.0.exe) |
| 🐧 **Linux** | x64 | [Boorie-1.18.0.AppImage](https://github.com/Boorie-AI/boorie_cliente/releases/download/v1.18.0/Boorie-1.18.0.AppImage) |
...
#### Linux
1. Download `Boorie-1.18.0.AppImage` from the link above
2. Make it executable: `chmod +x Boorie-1.18.0.AppImage`
3. Run: `./Boorie-1.18.0.AppImage`

#### Windows
1. Download `Boorie-Setup-1.18.0.exe` from the link above
